(function () {
  ...
  function getTemplate() {
    return [
      '<section class="sa-page app-content-v2">',
        '<div class="app-page-toolbar app-page-header sa-top-toolbar">',
          '<div class="app-page-toolbar-left app-page-header-main">',
            '<strong class="app-page-title">空间预约审批</strong>',
            '<div class="sa-tabs app-page-tabs app-view-tabs" role="tablist">',
          ...
          '<div class="app-page-toolbar-right app-page-header-actions">',
            '<a-input-search v-model="keyword" size="large" allow-clear class="sa-search app-page-search" placeholder="搜索申请人姓名或申请主题..."></a-input-search>',
          '</div>',
        '</div>',

        '<div class="sa-card app-page-body">',
          '<div class="sa-filter-row app-control-bar">',
          ...
          '<button v-if="conflictCount" type="button" class="sa-conflict-banner app-context-bar" @click="scrollToConflict">',
