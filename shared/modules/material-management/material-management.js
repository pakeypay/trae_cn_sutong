(function () {
  ...
  function renderShell() {
    ...
    content.innerHTML = '<div id="' + mountId + '" class="material-page-content app-content-v2">' + templateHtml + '</div>';
