      ...
      '<div class="cs-container">',
        ...
        '<div class="cs-dashboard">',
          '<div class="cs-kpi-card">',
            '<div class="cs-kpi-icon-wrapper">' + window.RoleNav.icons.graduationCap + '</div>',
          ...
          '</div>',
          '<div class="cs-kpi-card">',
            '<div class="cs-kpi-icon-wrapper">' + window.RoleNav.icons.flask + '</div>',
            '<div class="cs-kpi-info">',
          ...
          '</div>',
          '<div class="cs-kpi-card">',
            '<div class="cs-kpi-icon-wrapper">' + window.RoleNav.icons.pieChart + '</div>',
            '<div class="cs-kpi-info">',
            ...
            '<div v-for="course in filteredCourses" :key="course.id" class="cs-course-card" @click="openSelectionDrawer(course)">',
              ...
              '<div class="cs-course-info">',
                ...
                '<div class="cs-course-meta-tags">',
                  '<div class="cs-course-meta-item">' + window.RoleNav.icons.userCircle + ' 讲师: {{course.teacher}}</div>',
                  '<div class="cs-course-meta-item">' + window.RoleNav.icons.clock + ' 学时: {{course.hours}}学时</div>',
                  '<div class="cs-course-meta-item">' + window.RoleNav.icons.exclamationCircle + ' 取消截止: 开课前24小时</div>',
                '</div>',
              '</div>',
          ...
          '<div class="cs-right-panel">',
            ...
            '<div class="cs-side-card">',
              '<div class="cs-side-header" style="cursor:pointer;user-select:none;" @click="timetableCollapsed = !timetableCollapsed">',
                '<span>' + window.RoleNav.icons.calendar + ' 我的个人课表对齐</span>',
            ...
            '<div class="cs-side-card">',
              '<div class="cs-side-header">',
                '<span>' + window.RoleNav.icons.shoppingCart + ' 选课购物车 (暂存)</span>',
