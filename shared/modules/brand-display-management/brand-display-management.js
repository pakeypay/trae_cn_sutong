(function () {
  ...
  function getTemplate() {
    return [
      ...
      '      <a-tabs class="app-page-tabs bdm-tabs" :active-key="activeTab" @change="tabChanged"><a-tab-pane key="sign" title="班牌管理"></a-tab-pane><a-tab-pane key="screen" title="信息大屏"></a-tab-pane><a-tab-pane key="notice" title="通知公告"></a-tab-pane></a-tabs>',
      '    </div>',
      '    <div v-if="activeTab !== \'notice\'" class="app-page-toolbar-right">',
      ...
      '    <div class="bdm-toolbar"><div class="bdm-actions"><a-button type="primary" @click="openDevice(\'create\', activeTab)"><template #icon><icon-plus /></template>{{ activeTab === \'sign\' ? \'新建班牌\' : \'新建信息大屏\' }}</a-button><a-button @click="openNotice(\'create\')"><template #icon><icon-notification /></template>新建通知</a-button></div></div>',
