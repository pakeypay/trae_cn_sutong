(function () {
  ...
  const roles = {
    ...
    admin: {
      roleName: '超级管理员 / 院长', userName: '王院长', userRole: '超级管理员', avatar: '王', defaultActive: '排课工作台',
      notes: ['数据大屏展示全院的核心教学、物资与空间运行指标。', '首页承载全局数据、质量风险 and 待办。', '课程中心管理全量课程池、课程开发 and 课程审核。'],
      moduleEntrances: {
        '工作台': ['今日待办', '重点工作', '工作推进'],
        '数据大屏': ['师资情况', '学员情况', '课程情况', '评估情况', '物资情况', '空间情况'],
        '轮转管理': ['轮转安排', '教学活动'],
        '课程管理': ['课程开发', '课程池', '开课计划', '课程实施'],
        '排课管理': ['排课工作台', '开课条件总览', '已排课表', '报名情况'],
      ...
      navItems: [
        ...
        { label: '课程管理', icon: icons.book, children: ['课程开发', '课程池', '开课计划', '课程实施'] },
        { label: '排课管理', icon: icons.calendar, children: ['排课工作台', '开课条件总览', '已排课表', '报名情况'] },
    ...
    scheduler: {
      ...
      notes: ['待排课程、冲突检查、教师确认 and 通知发送放在排课工作台内。', '空间统计 and 空间冲突放在空间管理首页或工作台侧栏。', '不单独设置通知发布或数据看板导航。'],
      moduleEntrances: {
        '服务大厅': ['场地预约（含物资）', '我的申请'],
      ...
      navItems: [
        ...
        { label: '排课管理', icon: icons.calendar, children: ['排课工作台', '可视化排课', '开课条件总览', '已排课程管理', '报名情况'] },
        { label: '空间管理', icon: icons.space, children: ['空间预约审批', '空间资产管理', '班牌和大屏管理'] }
      ]
    },
    ...
    'academic-affairs': {
      ...
      navItems: [
        ...
        { label: '排课管理', icon: icons.calendar },
